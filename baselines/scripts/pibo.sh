...
#             device=3
#         fi
#         CUDA_VISIBLE_DEVICES=$device python baselines/algorithms/pibo.py --task $task --dim 200 --batch_size 100\
...
#         device=2
#     fi
#     CUDA_VISIBLE_DEVICES=$device python baselines/algorithms/pibo.py --task Rastrigin --dim $dim --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed 0 --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
...
#         device=3
#     fi
#     CUDA_VISIBLE_DEVICES=$device python baselines/algorithms/pibo.py --task Levy --dim $dim --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed 0 --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
...
#    CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task Ackley --dim 200 --batch_size 100\
...
# wait
# for seed in 0 1 2 3; do
#    CUDA_VISIBLE_DEVICES=3 python baselines/algorithms/pibo.py --task Ackley --dim 400 --batch_size 100\
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task Rastrigin --dim 200 --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed $seed --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
...
for seed in 0 1 2 3; do
    CUDA_VISIBLE_DEVICES=0 python baselines/algorithms/pibo.py --task Rastrigin --dim 400 --batch_size 100\
        --n_init 200 --max_evals 10000 --seed $seed --num_proxy_epochs 100 --num_prior_epochs 100 --num_posterior_epochs 100\
...
# for seed in 0; do
#     for ls in 10; do
#         CUDA_VISIBLE_DEVICES=3 python baselines/algorithms/pibo.py --task Levy --dim 200 --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed $seed --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=2 python baselines/algorithms/pibo.py --task Levy --dim 400 --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed $seed --num_proxy_epochs 100 --num_prior_epochs 100 --num_posterior_epochs 100\
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task Rosenbrock --dim 200 --batch_size 100\
#         --n_init 200 --max_evals 10000 --seed $seed --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
#         --local_search True --alpha 1e-4 --local_search_epochs 50 --diffusion_steps 30
# done
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task Rosenbrock --dim 400 --batch_size 100\
...
# for seed in 2; do
#     CUDA_VISIBLE_DEVICES=2 python baselines/algorithms/pibo.py --task Walker2d --dim 102 --batch_size 100\
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=0 python baselines/algorithms/pibo.py --task HalfCheetah --dim 102 --batch_size 100\
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=0 python baselines/algorithms/pibo.py --task Ant --dim 102 --batch_size 100\
#         --n_init 1000 --max_evals 10000 --seed $seed --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
#         --local_search True --alpha 1e-4 --local_search_epochs 30 --diffusion_steps 30 --buffer_size 500
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=0 python baselines/algorithms/pibo.py --task Humanoid --dim 102 --batch_size 100\
#         --n_init 1000 --max_evals 10000 --seed $seed --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50\
#         --local_search True --alpha 1e-4 --local_search_epochs 30 --diffusion_steps 30 --buffer_size 500
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task LunarLanding --dim 12 --batch_size 100\
...
# for seed in {0..4}; do
#     CUDA_VISIBLE_DEVICES=$seed python baselines/algorithms/pibo.py --task HalfCheetah --dim 102 \
...
# NOTE: HalfCheetah
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=3 python baselines/algorithms/pibo.py --task HalfCheetah --dim 102 \
#                                                                --batch_size 50 --n_init 100 --max_evals 2000 --seed $seed \
#                                                                --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50 \
...
# for seed in 0 1 2 3; do
#     CUDA_VISIBLE_DEVICES=1 python baselines/algorithms/pibo.py --task RoverPlanning --dim 100 \
#                                                                --batch_size 50 --n_init 100 --max_evals 2000 --seed $seed \
#                                                                --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50 \
...
# for seed in 2 3; do
#     for epoch in  30 ; do
#         CUDA_VISIBLE_DEVICES=3 python baselines/algorithms/pibo.py --task DNA --dim 180 \
#                                                                 --batch_size 50 --n_init 100 --max_evals 2000 --seed $seed \
#                                                                 --num_proxy_epochs 50 --num_prior_epochs 50 --num_posterior_epochs 50 \
